...
e.load_model('/mnt/afs/250010020/nmt_saved_models/transformer0114063222_from_other/transformer0114063222_epoch_27.pt')
loss = e.evaluate()
print(f'验证集 Loss: {loss:.3f}')
#e.train(n_epochs=10)
import time
strat=time.time()
e.test(e.train_pairs[0:30],show=True,strategy='beam')
end=time.time()
